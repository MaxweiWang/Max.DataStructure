...
namespace DataStructure.StructureFile
{
    ...
    public class RedBlackTreeDemo
    {
        public static void Show()
        {
            ...
            Console.WriteLine($"*******最小值:{tree.Min()}");
            Console.WriteLine($"*******最大值:{tree.Max()}");
            Console.WriteLine($"*******深度:{tree.Depth}");
            Console.WriteLine($"*******最大值:{tree.Count}");
            tree.SequentialTraversal();

            Console.WriteLine("移除Min Node");
            tree.RemoveMin();
            Console.WriteLine($"*******最小值:{tree.Min()}");
            Console.WriteLine($"*******最大值:{tree.Max()}");
            Console.WriteLine($"*******深度:{tree.Depth}");
